            ...
            >
                ...
                >
                    ...
                    <div v-if="!editMode" style="font-size:25px; font-weight:500; margin-left:20px; color:white;">
                            온도 &nbsp;<v-icon x-large color="white">mdi-temperature-celsius</v-icon>&nbsp;&nbsp;
                            풍속 km/h&nbsp;<v-icon x-large color="white">mdi-weather-windy-variant</v-icon><br>
                            강수확률 %&nbsp;<v-icon x-large color="white">mdi-umbrella</v-icon>&nbsp;&nbsp;
                            습도 %&nbsp;<v-icon x-large color="white">mdi-weather-rainy</v-icon>
                    </div>
                </v-img>
            </v-card>
        </v-card-text>
